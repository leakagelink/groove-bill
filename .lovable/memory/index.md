...
- [Sales Logic](mem://features/sales-logic) — Auto invoice numbering (CB-0001), 4 tabs: New/Recent, Sales Invoice, Estimate, Credit Notes (CN-0001)
...
- [Reports](mem://features/reports) — Sales, Purchase, Summary reports with date/payment filters and CSV export
